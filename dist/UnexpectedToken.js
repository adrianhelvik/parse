...
function UnexpectedToken(ctx) {
  ...
  var message = (0, _trace2.default)(ctx.source, ctx.tokens[ctx.index].index, 'Unexpected ' + token.type + ' "' + token.value + '". Expected ' + (0, _ruleToString2.default)(ctx.rule) + (0, _whileEvaluating2.default)(ctx) + '.' + partialMatchToString(ctx.partialMatch));
